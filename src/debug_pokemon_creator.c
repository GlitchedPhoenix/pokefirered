    ...
    for (i = 0; i < 6; i++)
    {
        ...
        default:
            ...
            *gStringVar3 = EOS;
            ...
            AddTextPrinterParameterized(sDebugPkmCreatorData.menuWindowId, FONT_NORMAL, gStringVar2, x, y, 0, NULL);
            break;
        case VAL_SPECIES:
            ConvertIntToDecimalStringN(gStringVar1, sDebugPkmCreatorData.data[index], STR_CONV_MODE_LEADING_ZEROS, data->digitCount);
            if (data->text != NULL)
        ...
        case VAL_LEVEL:
            ...
            *gStringVar3 = EOS;
            ...
            AddTextPrinterParameterized(sDebugPkmCreatorData.menuWindowId, FONT_NORMAL, gStringVar1, x, y, 0, NULL);
            break;
        case VAL_TID:
            ConvertIntToDecimalStringN(gStringVar1, sDebugPkmCreatorData.data[index], STR_CONV_MODE_LEADING_ZEROS, data->digitCount);
            if (data->text != NULL)
            ...
            *gStringVar3 = EOS;
            ...
            AddTextPrinterParameterized(sDebugPkmCreatorData.menuWindowId, FONT_NORMAL, gStringVar1, x, y, 0, NULL);
            x = 180;
            AddTextPrinterParameterized(sDebugPkmCreatorData.menuWindowId, FONT_NORMAL, GenderIndexes[sDebugPkmCreatorData.data[VAL_OT_GENDER]], x, y, 0, NULL);
            break;
        case VAL_PID:
            ConvertUIntToHexStringN(gStringVar1, sDebugPkmCreatorData.data[index], STR_CONV_MODE_LEADING_ZEROS, data->digitCount);
            if (data->text != NULL)
            ...
            *gStringVar3 = EOS;
            ...
            x = 208;
            AddTextPrinterParameterized(sDebugPkmCreatorData.menuWindowId, FONT_NORMAL, GenderIndexes[sDebugPkmCreatorData.data[VAL_PKM_GENDER]], x, y, 0, NULL);
            x = 214;
            AddTextPrinterParameterized(sDebugPkmCreatorData.menuWindowId, FONT_NORMAL, IsShinyIndex[sDebugPkmCreatorData.data[VAL_IS_SHINY]], x, y, 0, NULL);
            break;
        case VAL_OT_GENDER:
        case VAL_PKM_GENDER:
        ...
        case VAL_GAME:
            ...
            *gStringVar3 = EOS;
            ...
            AddTextPrinterParameterized(sDebugPkmCreatorData.menuWindowId, FONT_NORMAL, gStringVar2, x, y, 0, NULL);
            x = 130;
            AddTextPrinterParameterized(sDebugPkmCreatorData.menuWindowId, 1, gText_ThreeHyphens, x, y, 0, NULL);
            break;
        case VAL_ITEM:
            ConvertIntToDecimalStringN(gStringVar1, sDebugPkmCreatorData.data[index], STR_CONV_MODE_LEADING_ZEROS, data->digitCount);
            if (data->text != NULL)
...
static void DebugPkmCreator_EditModeRedraw(u32 digit, u8 editIndex)
{
    ...
    case VAL_PID:
        if (editIndex == 0) {
            ...
            AddTextPrinterParameterized(sDebugPkmCreatorData.menuWindowId, FONT_NORMAL, gStringVar2, x, y, 0, NULL);
            x = 214;
            AddTextPrinterParameterized(sDebugPkmCreatorData.menuWindowId, FONT_NORMAL, IsShinyIndex[isSihny], x, y, 0, NULL);
            x = 100;
        }
